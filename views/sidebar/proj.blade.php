...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion  show">
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        ...
        MenuItem($link = route('ActivityAnalysisSelectMod'), $label = 'Budget/Expenditure Y1-Y3');
        MenuItem($link = route('ActivityAnalysisSelectIntervention'), $label = 'Interventions Report Y1-Y3');
        MenuItem($link = route('ModuleTechnicalReport'), $label = 'Activity Tracking');
